<template>
  <div class="app-container">
      ...
      <el-form label-width="70px" size="small">
        ...
        <el-row style="display:flex">
          ...
          <div class="tools-div">
            ...
            <el-button type="warning" icon="el-icon-refresh" size="mini" @click="resetData">重置</el-button>
    ...
    <el-table
      ...
      <el-table-column prop="name" label="姓名" style="width: 15%"/>
      <el-table-column prop="phone" label="手机" style="width: 15%"/>
