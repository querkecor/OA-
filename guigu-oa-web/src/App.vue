  ...
  <div id="app">
    ...
    <el-dialog title="绑定手机" :visible.sync="dialogVisible" width="80%" >
      ...
      <span slot="footer" class="dialog-footer">
        <el-button type="primary" icon="el-icon-check"  size="small">确 定</el-button>
      </span>
    </el-dialog>
  </div>
</template>
  ...
  methods: {
    ...
    wechatLogin() {
      ...
      if(token === '') {
        ...
        //   window.location = 'http://oaaug.v5.idcfengye.com/admin/wechat/authorize?returnUrl=' + url
        // }
      }
    },
    ...
    saveBind() {
      ...
      userInfoApi.bindPhone(this.bindPhoneVo).then(response => {
        ...
        window.location = 'http://oaweb.v5.idcfengye.com'
      })
    },
